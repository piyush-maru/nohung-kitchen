...
class _UpcomingScreenState extends State<UpcomingScreen> {
                              ...
                              ListView.builder(
                                ...
                                itemBuilder: (context, index1) {
                                  return Column(
                                    children: [
                                      getOrderList(
                                          upcomingdata[index].data![index1]),
                                      (index1 + 1 ==
                                              upcomingdata[index].data!.length)
                                          ? SizedBox(
                                              height: 10,
                                            )
                                          : SizedBox()
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "${data.orderNumber} | ${dateTimeFormat(data.orderDate!, "MMMM dd, yyyy")}",
                                    style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 14,
  ...
  showAlertDialog(BuildContext context, GetUpComingOrderData data,
    ...
    orderDetails =
        await geteOrderDetails(context, data.orderId!, data.orderItemId!);
    orderDetails != null
        ? showDialog<void>(

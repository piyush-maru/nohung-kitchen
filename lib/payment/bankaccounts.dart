...
class _BankAccountsState extends State<BankAccounts> {
  ...
  Future EditBank(BuildContext context) async {
    ...
    try {
      ...
      var bean = await ApiProvider().editBankAccount(accountName.text,bank.text,IfscCode.text,accountnumber.text);
  ...
  Future<BeanAddAccount?> addAccount() async {
    ...
    try {
      ...
      BeanAddAccount? bean = await ApiProvider().beanAddAccount(accountName.text,bank.text,IfscCode.text,accountnumber.text);

          ...
          children: [
            ...
            data.isEmpty
                ? Container(
                    ...
                    child: Text("NO Data",style: TextStyle(fontFamily: AppConstant.fontRegular),))
                : SizedBox(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Spacer(),
                Text(wallets.category=="Deduct"?"(-)${wallets.addonAmount}":"(+)${wallets.addonAmount}",
                  style: TextStyle(
                      fontFamily: AppConstant.fontBold, color: Colors.black),
                )
              ],
            ...
            Row(
              ...
              children: [
                ...
                Spacer(),
                Text(
                  wallets.status=="Rejected" ||  wallets.status=="Pending"?"-":
                ...
                ElevatedButton(
                    ...
                    style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.all(
                            wallets.status == "Rejected"?Colors.red:
                            wallets.status == "Paid"
                                ? Color(0xFF28A745)
                                : Color(0xFFFFC107))),
                    child: Text(
                      ...
                      style: TextStyle(
                          ...
                          color: wallets.status == "Rejected"?Colors.white:Colors.black),
                    )),
              ],
            ),
            SizedBox(

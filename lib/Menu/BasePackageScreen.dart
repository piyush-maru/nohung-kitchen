...
import 'package:kitchen/Menu/package_detail_screen.dart';
  ...
  Widget getItems(BeanGetPackagesData item) {
    ...
    return LayoutBuilder(
      builder: (_, c) {
        ...
        final mealForList = [];
        if (item.mealfor!.contains('0')) {
          mealForList.add("Breakfast");
        }
        if (item.mealfor!.contains('1')) {
          mealForList.add("Lunch");
        }
        if (item.mealfor!.contains('2')) {
          mealForList.add("Dinner");
        }
        ...
        return InkWell(
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                PackageDetailScreen(packageId: item.packageId,userID: item.userId,)
              ),
            );
          },
          child: Container(
